...
type SharedInformerFactory interface {
	...
	Storage() storagecapability.Interface
}

func (f *sharedInformerFactory) Storage() storagecapability.Interface {
	return storagecapability.New(f, f.namespace, f.tweakListOptions)
}
